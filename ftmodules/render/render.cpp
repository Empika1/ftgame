...
void FTRender::_bind_methods() {
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, STATIC_RECT_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, STATIC_RECT_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, STATIC_CIRC_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, STATIC_CIRC_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, DYNAMIC_RECT_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, DYNAMIC_RECT_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, DYNAMIC_CIRC_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, DYNAMIC_CIRC_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, GP_RECT_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, GP_RECT_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, GP_CIRC_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, GP_CIRC_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, WOOD_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, WOOD_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, WATER_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, WATER_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, CW_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, CW_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, CW_DECAL);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, CCW_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, CCW_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, CCW_DECAL);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, UPW_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, UPW_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, UPW_DECAL);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, BUILD_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, BUILD_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, GOAL_BORDER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, GOAL_INSIDE);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, JOINT_NORMAL);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, JOINT_WHEEL_CENTER);
    BIND_ENUM_CLASS_CONSTANT(FT, ObjType, SIZE);

    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, STATIC_RECT);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, STATIC_CIRC);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, DYNAMIC_RECT);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, DYNAMIC_CIRC);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, GP_RECT);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, GP_CIRC);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, CW);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, CCW);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, UPW);
	BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, WOOD);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, WATER);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, BUILD);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, GOAL);
    BIND_ENUM_CLASS_CONSTANT(FTRender, PieceType, SIZE);

    BIND_ENUM_CLASS_CONSTANT(FT, SdfType, ROUNDED_RECT);
    BIND_ENUM_CLASS_CONSTANT(FT, SdfType, CW);
    BIND_ENUM_CLASS_CONSTANT(FT, SdfType, CCW);
    BIND_ENUM_CLASS_CONSTANT(FT, SdfType, UPW);
    BIND_ENUM_CLASS_CONSTANT(FT, SdfType, SIZE);
